...
- [Peter M. Senge — The Fifth Discipline: The Art & Practice of the Learning Organization (1990)](https://leeds-faculty.colorado.edu/larsenk/learnorg/senge.html)
...
- [Meadows, Leverage Points (PDF, The Academy for Systems Change)](https://donellameadows.org/wp-content/userfiles/Leverage_Points.pdf)
- [Wikipedia: Twelve leverage points](https://en.wikipedia.org/wiki/Twelve_leverage_points)
- [Systems and Complexity in Organisation (SCiO): Leverage Points](https://www.systemspractice.org/resources/leverage-points-places-intervene-system)
- [Image: Spider web with dew and trunk — Wikimedia Commons (Public domain), pixelated](https://commons.wikimedia.org/wiki/File:Spider_web_with_dew_and_trunk.JPG)
